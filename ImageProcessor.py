...
def cleanImage():
    img = cv2.imread('D:/testImage/8.png')
    height = img.shape[0]
    width = img.shape[1]
    ...
    cv2.imwrite('D:/trainImage/2.png', gray_img)
    return gray_img

def im2bw():
    img = cv2.imread('D:/trainImage/2.png',0)
    ...
    cv2.imwrite('D:/trainImage/final_image.png', thresh1)
